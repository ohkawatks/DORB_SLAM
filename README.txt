...
#4 Running Distribution type 1 (ORB extracter is distrbuted)
...
#5 Running Distribution type 2 (bundle adjustment is distrbuted)
...
#6 Running Distribution type 3 node (ORB extractor and local bundle adjustment is distrbuted)
